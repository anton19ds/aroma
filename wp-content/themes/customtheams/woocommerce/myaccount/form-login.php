...
<div class="container">
        ...
        <h2>Войдите в систему как существующий клиент.</h2>
       ...
       <div class="form-group login-button-or">
			...
			<p class="form-row">
				...
				<a   class="forgot-password" href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost your password?', 'woocommerce' ); ?></a>
